...
public final class StaticPowerDemand extends AbstractDemand implements
		INodeConstraint {
	public StaticPowerDemand(Node<? extends AbstractConstraint> owner) {
		super(owner);
	}
	
	public StaticPowerDemand(Node<? extends AbstractConstraint> owner, String name) {
		super(owner, name);
	}
	...
	public AbstractDemand getCopy(NetworkEntity<? extends AbstractDemand> owner) {
		StaticPowerDemand clone = new StaticPowerDemand((Node<? extends AbstractConstraint>) owner, this.getName());
		return clone;
	}
}
