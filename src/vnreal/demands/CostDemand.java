 ...
 */
public final class CostDemand extends AbstractDemand implements	ILinkConstraint {
	private double cost;

	public CostDemand(Link<? extends AbstractConstraint> owner) {
		super(owner);
	}
	...
	public String toString() {
		return "CostDemand: total cost = " + getCost();
	}

    @Override
    public AbstractDemand getCopy(NetworkEntity<? extends AbstractDemand> owner) {
        CostDemand copy = new CostDemand((Link<? extends AbstractConstraint>) owner);
