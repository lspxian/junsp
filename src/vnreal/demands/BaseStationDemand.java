...
import vnreal.resources.BaseStationResource;
import vnreal.resources.ResourceVisitorAdapter;

public final class BaseStationDemand extends AbstractDemand implements INodeConstraint,
		ILinkConstraint {

	public BaseStationDemand(Node<? extends AbstractConstraint> owner) {
		super(owner);
	}

	public BaseStationDemand(Link<? extends AbstractConstraint> owner) {
		super(owner);
	}
	
	public BaseStationDemand(Node<? extends AbstractConstraint> owner, String name) {
		super(owner, name);
	}
	
	public BaseStationDemand(Link<? extends AbstractConstraint> owner, String name) {
		super(owner, name);
	}
...
//						.roundThreeDecimals(getDemandedCycles());
	...
	public String toString() {
		return new String("BaseStationDemand");
	}

	@Override
	public AbstractDemand getCopy(NetworkEntity<? extends AbstractDemand> owner) {
		BaseStationDemand clone = new BaseStationDemand((Node<? extends AbstractConstraint>) owner, this.getName());
