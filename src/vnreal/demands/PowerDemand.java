...
public class PowerDemand extends AbstractDemand implements INodeConstraint {

	public PowerDemand(Node<? extends AbstractConstraint> owner) {
		super(owner);
	}
	
	public PowerDemand(Node<? extends AbstractConstraint> owner, String name) {
		super(owner, name);
	}
	...
	public String toString() {
		return new String("PowerDemand");
	}

	@Override
	public AbstractDemand getCopy(NetworkEntity<? extends AbstractDemand> owner) {
		PowerDemand clone = new PowerDemand((Node<? extends AbstractConstraint>) owner, this.getName());
