...
public class ProbaHeuristic1 extends AbstractProbaLinkMapping {
	...
	public boolean linkMapping(VirtualNetwork vNet, Map<VirtualNode, SubstrateNode> nodeMapping) {
		...
		/*
		this.dijkstra = new DijkstraShortestPath<SubstrateNode,SubstrateLink> (this.sNet, new Transformer<SubstrateLink, Double>(){
		...
		Collections.sort(this.virtualLinks,new Comparator<VirtualLink>(){

			@Override
			public int compare(VirtualLink o1, VirtualLink o2) {
				double demand1 = o1.getBandwidthDemand().getDemandedBandwidth();
				double demand2 = o2.getBandwidthDemand().getDemandedBandwidth();
